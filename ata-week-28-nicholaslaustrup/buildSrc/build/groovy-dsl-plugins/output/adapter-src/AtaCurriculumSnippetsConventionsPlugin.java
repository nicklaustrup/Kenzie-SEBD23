 ...
 **/
public class AtaCurriculumSnippetsConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_AtaCurriculumSnippetsConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("ata-curriculum.java-conventions");
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AtaCurriculumSnippetsConventions").asSubclass(BasicScript.class);

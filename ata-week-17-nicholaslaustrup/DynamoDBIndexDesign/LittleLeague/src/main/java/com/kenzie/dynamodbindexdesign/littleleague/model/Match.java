...
public class Match {
    public final static String HOME_TEAM_MATCHES_INDEX = "HomeTeamMatchesIndex";
    public final static String AWAY_TEAM_MATCHES_INDEX = "AwayTeamMatchesIndex";
    ...
    @DynamoDBIndexRangeKey(globalSecondaryIndexNames = {HOME_TEAM_MATCHES_INDEX, AWAY_TEAM_MATCHES_INDEX})
    ...
    @DynamoDBIndexHashKey(globalSecondaryIndexName = AWAY_TEAM_MATCHES_INDEX, attributeName = "awayTeam")

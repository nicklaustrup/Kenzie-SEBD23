...
public class BookApp {
    ...
    public static void main(String[] args) {
        ...
        //THEN (1st query call)
        System.out.println("The first query call when limit = 2 retrieves the 2 books with titles My Side Of The Mountain and " +
                "To Kill a Mockingbird: " + helperMethods.getTitlesFromList(queryBookList).toString());

        //GIVEN (2nd query call)
        exclusiveStartAsin = "03287622";

        //WHEN (2nd query call)
        queryBookList = bookDAO.getBooksReadByEmployee(employeeId, exclusiveStartAsin, limit);

        //THEN (2nd query call)
        System.out.println("The second query call when limit = 2 retrieves the book with title The Book Thief " +
                ": " + helperMethods.getTitlesFromList(queryBookList).toString());
    }
}

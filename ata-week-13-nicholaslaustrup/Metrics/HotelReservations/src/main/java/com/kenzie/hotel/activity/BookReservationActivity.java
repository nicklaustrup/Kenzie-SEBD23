...
public class BookReservationActivity {
    ...
    public Reservation handleRequest(Reservation reservation) {
        ...
        metricsPublisher.addMetric(MetricsConstants.BOOKINGS_COUNT, 1, StandardUnit.Count);
        metricsPublisher.addMetric(MetricsConstants.REVENUE, reservation.getTotalCost().doubleValue(), StandardUnit.None);
        return response;
    }
}

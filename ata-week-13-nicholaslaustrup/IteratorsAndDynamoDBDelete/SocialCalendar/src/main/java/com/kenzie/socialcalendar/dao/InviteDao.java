...
public class InviteDao {
    ...
    public boolean deleteInvite(String eventId, String memberId) {
        try {
            //Fetch invite
            Invite inviteToDelete = getInvite(eventId, memberId);
            if (inviteToDelete == null){
                throw new ConditionalCheckFailedException("Either invite does not exist or Event / Member Id is incorrect.");
            }
            //Create conditional delete expression

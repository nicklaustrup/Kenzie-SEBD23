...
public class SamplePartList {
    ...
    public static void main(String[] args){
        ...
        //Adding the parts to PartsManager list
        ...
        System.out.println(microphonePartManager.isDevicePartIncluded(flex));
        System.out.println(microphonePartManager.removeSpecificPart(flex));
    }
}

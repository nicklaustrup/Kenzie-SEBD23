...
public class Main {
    ...
    final public static int TOTAL_MILES = 1600;
    final public static int MILES_PER_DAY = 20;
    final public static int FOOD_EXCHANGE = 4;
    final public static int MAX_DAYS = 100;
    final public static int WAGON_SIZE =  6; // (Total capacity -- choose either 4, 8 or 12)
    final public static int HUNT_DAYS = 6; //how often you stop and hunt
    final public static int NUM_TRAVELERS = 1;
    final public static int NUM_HUNTERS = 3;
    final public static int NUM_DOCTORS = 2;
